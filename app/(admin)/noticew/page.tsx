...
import WriteNotice from "@/utils/notice/write";
import EditNotice from "@/utils/notice/edit";
import styles from "./page.module.css";

export default function NoitceWrite() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (isEditMode) {
        // 수정 모드
        await EditNotice(titleValue.trim(), contentValue.trim(), editPostId);
        router.push(`/notice/${editPostId}`);
      } else {
        // 작성 모드
        const noticeId = await WriteNotice(titleValue.trim(), contentValue.trim());
